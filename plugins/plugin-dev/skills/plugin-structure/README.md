...
Comprehensive guidance on OpenSIN Code plugin architecture, directory layout, and best practices.
...
- Portable path references with `${OPENSIN_PLUGIN_ROOT}`
...
- Ask about "${OPENSIN_PLUGIN_ROOT}" usage
...
OpenSIN loads references and examples only as needed based on the task.
