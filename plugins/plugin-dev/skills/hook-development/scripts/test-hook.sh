...
# Set up environment
export OPENSIN_PROJECT_DIR="${OPENSIN_PROJECT_DIR:-/tmp/test-project}"
export OPENSIN_PLUGIN_ROOT="${OPENSIN_PLUGIN_ROOT:-$(pwd)}"
export OPENSIN_ENV_FILE="${OPENSIN_ENV_FILE:-/tmp/test-env-$$}"

if [ "$VERBOSE" = true ]; then
  echo "Environment:"
  echo "  OPENSIN_PROJECT_DIR=$OPENSIN_PROJECT_DIR"
  echo "  OPENSIN_PLUGIN_ROOT=$OPENSIN_PLUGIN_ROOT"
  echo "  OPENSIN_ENV_FILE=$OPENSIN_ENV_FILE"
  echo ""
fi
...
if [ -f "$OPENSIN_ENV_FILE" ]; then
  echo ""
  echo "Environment file created:"
  cat "$OPENSIN_ENV_FILE"
  rm -f "$OPENSIN_ENV_FILE"
fi
