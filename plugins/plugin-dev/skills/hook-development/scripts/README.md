...
Tests individual hook scripts with sample input before deploying to OpenSIN Code.
...
**Features:**
- Sets up proper environment variables (OPENSIN_PROJECT_DIR, OPENSIN_PLUGIN_ROOT)
...
- Path in hooks.json is correct (use `${OPENSIN_PLUGIN_ROOT}`)
