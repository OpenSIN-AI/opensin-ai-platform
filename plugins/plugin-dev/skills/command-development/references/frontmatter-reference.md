...
**Purpose:** Specify which OpenSIN model executes the command
...
- OpenSIN can invoke programmatically
...
**Best practices:**
- Use sparingly (limits OpenSIN's autonomy)
...
**Invalid model name:**
```yaml
model: gpt4  # ❌ Not a valid OpenSIN model
```
