...
**Important:** All examples below are written as instructions FOR OpenSIN (agent consumption), not messages TO users. Commands tell OpenSIN what to do, not tell users what will happen.

## Example 1: Code Review Command

**File:** `.opensin/commands/review.md`
...
**File:** `.opensin/commands/security-review.md`
...
**File:** `.opensin/commands/test-file.md`
...
**File:** `.opensin/commands/document.md`
...
**File:** `.opensin/commands/git-status.md`
...
**File:** `.opensin/commands/deploy.md`
...
**File:** `.opensin/commands/compare-files.md`
...
**File:** `.opensin/commands/quick-fix.md`
...
**File:** `.opensin/commands/research.md`
...
**File:** `.opensin/commands/explain.md`
