...
**.opensin/experimental-features.local.md:**
...
# Read settings
FRONTMATTER=$(sed -n '/^---$/,/^---$/{ /^---$/d; p; }' ".opensin/my-plugin.local.md")
...
```bash
# Edit settings
vim .opensin/my-plugin.local.md

# Changes take effect after restart
exit  # Exit OpenSIN Code
opensin  # Restart
```

Changes require OpenSIN Code restart - hooks can't be hot-swapped.
