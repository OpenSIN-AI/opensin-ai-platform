...
assistant: "[How OpenSIN should respond before triggering]"
<commentary>
[Explanation of why this agent should be triggered in this scenario]
</commentary>
assistant: "[How OpenSIN triggers the agent - usually 'I'll use the [agent-name] agent...']"
</example>
```
...
**Purpose:** Show what OpenSIN says before launching the agent
...
**Purpose:** Show how OpenSIN invokes the agent
