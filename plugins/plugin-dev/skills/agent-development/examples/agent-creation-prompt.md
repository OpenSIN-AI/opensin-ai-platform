...
Use this template to generate agents using OpenSIN with the agent creation system prompt.
...
Send this to OpenSIN (with the agent-creation-system-prompt loaded):
...
Tell OpenSIN when the agent should activate:
...
- **Comprehensive**: OpenSIN includes edge cases and quality checks
