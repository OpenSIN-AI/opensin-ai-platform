...
3. Check adherence to project best practices and coding standards from OPENSIN.md
...
5. **Best Practices**:
   - Follow project-specific standards from OPENSIN.md
...
- Missing context (no OPENSIN.md): Apply general best practices
