...
2. Gathers relevant OPENSIN.md guideline files from the repository
3. Summarizes the pull request changes
4. Launches 4 parallel agents to independently review:
   - **Agents #1 & #2**: Audit for OPENSIN.md compliance
...
- OPENSIN.md compliance checking with explicit guideline verification
...
1. Missing error handling for OAuth callback (OPENSIN.md says "Always handle OAuth errors")
...
3. Inconsistent naming pattern (src/conventions/OPENSIN.md says "Use camelCase for functions")
...
- General quality issues (unless in OPENSIN.md)
- Issues with lint ignore comments

## Installation

This plugin is included in the OpenSIN Code repository. The command is automatically available when using OpenSIN Code.

## Best Practices

### Using `/code-review`
- Maintain clear OPENSIN.md files for better compliance checking
- Trust the 80+ confidence threshold - false positives are filtered
- Run on all non-trivial pull requests
- Review agent findings as a starting point for human review
- Update OPENSIN.md based on recurring review patterns
...
- OPENSIN.md files (optional but recommended for guideline checking)
...
- Make OPENSIN.md more specific about what matters
...
- **Write specific OPENSIN.md files**: Clear guidelines = better reviews
- **Include context in PRs**: Helps agents understand intent
- **Use confidence scores**: Issues ≥80 are usually correct
- **Iterate on guidelines**: Update OPENSIN.md based on patterns
...
### Agent architecture
- **2x OPENSIN.md compliance agents**: Redundancy for guideline checks
...
- For OPENSIN.md issues: verifies guideline explicitly mentions it
...
Boris Cherny (boris@opensin.com)
