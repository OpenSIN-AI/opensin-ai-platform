...
Simply ask questions that match an agent's focus area, and OpenSIN will automatically trigger the appropriate agent:
...
OpenSIN may proactively use these agents based on context:
...
- User agents: `~/.opensin/agents/`
- Project agents: `.opensin/agents/` in opensin-cli-internal
