...
# Feeds OpenSIN's output back as input to continue the loop
...
if [[ ! -f "$TRANSCRIPT_PATH" ]]; then
  ...
  echo "   This is unusual and may indicate a OpenSIN Code internal issue." >&2
...
# The "reason" field contains the prompt that will be sent back to OpenSIN
jq -n \
