...
1. **SDK Installation and Configuration**:
   ...
   - Verify `@opensin-ai/opensin-agent-sdk` is installed
...
3. **SDK Usage and Patterns**:
   ...
   - Verify correct imports from `@opensin-ai/opensin-agent-sdk`
...
2. **Check SDK Documentation Adherence**:
   ...
   - Use WebFetch to reference the official TypeScript SDK docs: https://docs.opensin.com/en/api/agent-sdk/typescript
