...
A comprehensive plugin for creating and verifying OpenSIN Agent SDK applications in Python and TypeScript.
...
Interactive command that guides you through creating a new OpenSIN Agent SDK application.
...
```bash
# Set your API key
echo "OPENSIN_API_KEY=your_key_here" > .env
...
This plugin is included in the OpenSIN Code repository. To use it:

1. Ensure OpenSIN Code is installed
...
- [Agent SDK Overview](https://docs.opensin.com/en/api/agent-sdk/overview)
- [TypeScript SDK Reference](https://docs.opensin.com/en/api/agent-sdk/typescript)
- [Python SDK Reference](https://docs.opensin.com/en/api/agent-sdk/python)
- [Agent SDK Examples](https://docs.opensin.com/en/api/agent-sdk/examples)
...
**Issue**: Cannot import from `opensin_agent_sdk`

**Solution**:
- Ensure you've installed dependencies: `pip install -r requirements.txt`
- Activate your virtual environment if using one
- Check that the SDK is installed: `pip show opensin-agent-sdk`
...
Ashwin Bhat (ashwin@opensin.com)
