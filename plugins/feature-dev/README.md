...
OpenSIN: Let me understand what you need...
...
- OpenSIN reads all identified files to build deep understanding
...
**Focus areas:**
- Project guideline compliance (OPENSIN.md)
- Bug detection
- Code quality issues
...
Sid Bidasaria (sbidasaria@opensin.com)
