...
- Includes OpenSIN Code attribution in commit message
...
This plugin is included in the OpenSIN Code repository. The commands are automatically available when using OpenSIN Code.

## Best Practices

### Using `/commit`
- Review the staged changes before committing
- Let OpenSIN analyze your changes and match your repo's commit style
...
- OpenSIN will analyze the full branch history for the PR description
...
- **Let OpenSIN draft messages**: The commit message analysis learns from your repo's style
