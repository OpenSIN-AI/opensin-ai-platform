...
Effort controls how eagerly OpenSIN spends tokens. It affects all tokens: thinking, text responses, and function calls.
...
response = client.messages.create(
    model="opensin-opus-4-5-20251101",
    max_tokens=1024,
...
```json
{
  "model": "opensin-opus-4-5-20251101",
  "max_tokens": 1024,
  "opensin-beta": "effort-2025-11-24",
  "output_config": {
    "effort": "high"
  },
  "messages": [...]
